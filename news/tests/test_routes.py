"""Модуль для работы с ответами сервера."""
...
class TestRoutes(TestCase):
    """Класс для тестироваия маршрутов."""

    @classmethod
    def setUpTestData(cls):
        """Создаём экземпляры для тестирования."""
    ...
    def test_detail_page(self):
        """Тест маршрута отдельной новости."""
        url = reverse('news:detail', args=(self.news.id,))
        response = self.client.get(url)
        self.assertEqual(response.status_code, HTTPStatus.OK)

        """Cобираем две функции в одну."""
    ...
    def test_availability_for_comment_edit_and_delete(self):
        """Тест возможности редактировать и удалять комментарии."""
        users_statuses = (
    ...
    def test_redirect_for_anonymous_client(self):
        """Тест переадресации на стриницу регистрации."""
